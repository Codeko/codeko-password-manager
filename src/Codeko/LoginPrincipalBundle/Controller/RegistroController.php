 ...
 */
class RegistroController extends ContainerAware
{
    public function registroAction()
    {
        ...
        return $this->container->get('templating')->renderResponse('CodekoLoginPrincipalBundle:Registro:registro.html.'.$this->getEngine(), array(
