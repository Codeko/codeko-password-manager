...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '/prueba') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'AcmePruebaBundle_homepage');
            }
            return array (  '_controller' => 'Acme\\PruebaBundle\\Controller\\DefaultController::indexAction',  '_route' => 'AcmePruebaBundle_homepage',);
        }
