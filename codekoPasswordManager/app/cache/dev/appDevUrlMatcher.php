...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if ($pathinfo === '/registro') {
            return array (  '_controller' => 'Acme\\LoginPrincipalBundle\\Controller\\RegistroController::registroAction',  '_route' => 'registro',);
        }

        // principal
        if ($pathinfo === '/principal') {
            return array (  '_controller' => 'Acme\\LoginPrincipalBundle\\Controller\\PrincipalController::principalAction',  '_route' => 'principal',);
        }
        ...
        if (0 === strpos($pathinfo, '/log')) {
            if (0 === strpos($pathinfo, '/login')) {
                ...
                if ($pathinfo === '/login') {
                    return array (  '_controller' => 'Acme\\LoginPrincipalBundle\\Controller\\SecurityController::loginAction',  '_route' => 'fos_user_security_login',);
                }
                ...
                if ($pathinfo === '/login_check') {
                    ...
                    return array (  '_controller' => 'Acme\\LoginPrincipalBundle\\Controller\\SecurityController::checkAction',  '_route' => 'fos_user_security_check',);
                }
            ...
            if ($pathinfo === '/logout') {
                return array (  '_controller' => 'Acme\\LoginPrincipalBundle\\Controller\\SecurityController::logoutAction',  '_route' => 'fos_user_security_logout',);
            }
        ...
        if (0 === strpos($pathinfo, '/registro')) {
            ...
            if (rtrim($pathinfo, '/') === '/registro') {
                ...
                return array (  '_controller' => 'Acme\\LoginPrincipalBundle\\Controller\\RegistroController::registroAction',  '_route' => 'fos_user_registration_register',);
            }
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            return array (  '_controller' => 'Acme\\LoginPrincipalBundle\\Controller\\SecurityController::loginAction',  '_route' => 'default',);
        }
        ...
        if (0 === strpos($pathinfo, '/log')) {
            if (0 === strpos($pathinfo, '/login')) {
                // login
                if ($pathinfo === '/login') {
                    return array (  '_controller' => 'Acme\\LoginPrincipalBundle\\Controller\\SecurityController::loginAction',  '_route' => 'login',);
                }
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            return array (  '_controller' => 'Acme\\LoginPrincipalBundle\\Controller\\SecurityController::loginAction',  '_route' => '_login',);
        }

        // _principal
        if ($pathinfo === '/principal') {
            return array (  '_controller' => 'Acme\\LoginPrincipalBundle\\Controller\\PrincipalController::principalAction',  '_route' => '_principal',);
        }

        // _registro
        if ($pathinfo === '/registro') {
            return array (  '_controller' => 'Acme\\LoginPrincipalBundle\\Controller\\RegistroController::registroAction',  '_route' => '_registro',);
        }
