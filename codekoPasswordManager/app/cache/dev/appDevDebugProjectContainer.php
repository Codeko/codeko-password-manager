...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmePruebaBundle', '/home/abex/NetBeansProjects/codekopasswordmanager/codekoPasswordManager/app/Resources/AcmePruebaBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmePruebaBundle', '/home/abex/NetBeansProjects/codekopasswordmanager/codekoPasswordManager/src/Acme/PruebaBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeUsersDBBundle', '/home/abex/NetBeansProjects/codekopasswordmanager/codekoPasswordManager/app/Resources/AcmeUsersDBBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeUsersDBBundle', '/home/abex/NetBeansProjects/codekopasswordmanager/codekoPasswordManager/src/Acme/UsersDBBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeLoginBundle', '/home/abex/NetBeansProjects/codekopasswordmanager/codekoPasswordManager/app/Resources/AcmeLoginBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeLoginBundle', '/home/abex/NetBeansProjects/codekopasswordmanager/codekoPasswordManager/src/Acme/LoginBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(new \Symfony\Bridge\Doctrine\Annotations\IndexedReader($this->get('annotation_reader')), array(0 => '/home/abex/NetBeansProjects/codekopasswordmanager/codekoPasswordManager/src/Acme/UsersDBBundle/Entity')), 'Acme\\UsersDBBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('AcmeUsersDBBundle' => 'Acme\\UsersDBBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('/home/abex/NetBeansProjects/codekopasswordmanager/codekoPasswordManager/app/cache/dev/doctrine/orm/Proxies');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AcmeUsersDBBundle' => 'Acme\\UsersDBBundle\\AcmeUsersDBBundle',
                'AcmeLoginBundle' => 'Acme\\LoginBundle\\AcmeLoginBundle',
